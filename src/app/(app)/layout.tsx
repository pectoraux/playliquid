...
const NAV_BY_ROLE: Record<string, NavItem[]> = {
  ...
  moderator: [
    ...
    { label: 'Flagged Games', href: '/flagged-games', icon: AlertTriangle },
    { label: 'Anti-Cheat', href: '/anti-cheat', icon: Shield },
  ...
  finance: [
    ...
    { label: 'Liquidity', href: '/liquidity', icon: WalletIcon },
  ...
  developer: [
    ...
    { label: 'API', href: '/api-docs', icon: Boxes },
    { label: 'Profile', href: '/profile', icon: UserIcon },
  ],
};
